...
# A5. In the save method. When we have saved a database to the database the db creates an id.
...
# A10. arguments find_by_id integer or find_by_address string. The arrays.
